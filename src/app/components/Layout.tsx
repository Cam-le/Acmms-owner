...
export function AppLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#f1f5f9] overflow-hidden font-sans">
      {/* Sidebar */}
      <aside className="w-[260px] bg-[#009689] flex flex-col shrink-0 text-white shadow-xl z-20">
        {/* Logo */}
        <div className="h-[80px] flex items-center px-6 gap-3 shrink-0">
          <div className="w-10 h-10 bg-[#ffffff33] rounded-[10px] flex items-center justify-center shadow-sm">
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-3 rounded-[10px] transition-all duration-200 group ${
                  isActive
                    ...
                    : "text-[#ffffffcc] hover:bg-[#ffffff1a] hover:text-white hover:pl-5"
                }`
              }
            >
        ...
        <div className="p-4 mt-auto">
          <Popover.Root>
            <Popover.Trigger asChild>
              <button className="w-full bg-[#007f73] hover:bg-[#006d63] active:scale-[0.98] transition-all rounded-[12px] p-3 flex items-center gap-3 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-white/50">
