import svgPaths from "./svg-y2z67f5xiv";
import imgImage21 from "figma:asset/9e9df098d045eed7a0523b6e463309ac35a21903.png";
  ...
  return (
    <div className="bg-[#009689] h-[39.971px] relative rounded-[9.995px] shrink-0 w-[174.791px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[23.988px] left-[99.46px] text-[15.992px] text-center text-white top-[6.2px]">Thêm nhân viên</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[21.204px] relative shrink-0 w-[140.726px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[21.21px] left-0 text-[#101828] text-[15.15px] top-[-1.81px]">Thêm nhân viên mới</p>
      </div>
    </div>
  );
}
...
function Icon11() {
  return (
    <div className="h-[18.177px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6033 10.6033">
            <path d={svgPaths.p1f98ee40} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.51476" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6033 10.6033">
            <path d={svgPaths.p205c7c40} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.51476" />
          </svg>
        </div>
      </div>
    </div>
...
function Button13() {
  return (
    <div className="relative shrink-0 size-[18.177px]" data-name="Button">
...
function Container17() {
  return (
    <div className="h-[58.018px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b-[0.459px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[0.459px] px-[18.177px] relative size-full">
          <Heading2 />
          <Button13 />
        </div>
      </div>
...
function Label() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.29px] w-[46.297px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Họ và tên</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="absolute h-[31.197px] left-0 rounded-[7.575px] top-[18.18px] w-[303px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[12.12px] py-[6.06px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12.12px] text-[rgba(10,10,10,0.5)]">Nhập họ tên đầy đủ</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[0.459px] border-solid inset-0 pointer-events-none rounded-[7.575px]" />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="h-[49.381px] relative shrink-0 w-[303px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function Label1() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.3px] w-[25.96px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Email</p>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="absolute h-[31.197px] left-0 rounded-[7.575px] top-[18.18px] w-[303px]" data-name="Email Input">
      <div className="content-stretch flex items-center overflow-clip px-[12.12px] py-[6.06px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12.12px] text-[rgba(10,10,10,0.5)]">worker@example.com</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[0.459px] border-solid inset-0 pointer-events-none rounded-[7.575px]" />
    </div>
  );
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.29px] w-[46.297px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Số điện thoại</p>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute h-[31.197px] left-0 rounded-[7.575px] top-[18.18px] w-[303px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[12.12px] py-[6.06px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12.12px] text-[rgba(10,10,10,0.5)]">Nhập số điện thoại</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[0.459px] border-solid inset-0 pointer-events-none rounded-[7.575px]" />
    </div>
  );
...
function Label3() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.29px] w-[46.297px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Vai Trò</p>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="absolute border-[#e5e7eb] border-[0.459px] border-solid h-[31.197px] left-0 overflow-clip rounded-[7.575px] top-[18.18px] w-[303px]" data-name="Text Input">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[normal] left-[11.66px] text-[#0a0a0a] text-[12.12px] top-[8.14px]">Người Làm Nông</p>
      <div className="absolute left-[273.54px] size-[29px] top-[2.2px]" data-name="image 21">
...
function Label4() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.3px] w-[45.55px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Mật khẩu</p>
    </div>
  );
}
...
function PasswordInput() {
  return (
    <div className="absolute h-[31.197px] left-0 rounded-[7.575px] top-0 w-[303px]" data-name="Password Input">
      <div className="content-stretch flex items-center overflow-clip pl-[12.12px] pr-[30.3px] py-[6.06px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12.12px] text-[rgba(10,10,10,0.5)]">••••••••</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[0.459px] border-solid inset-0 pointer-events-none rounded-[7.575px]" />
    </div>
  );
...
function Icon12() {
  return (
    <div className="h-[13.629px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[20.83%_8.33%_20.84%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.4941 9.08548">
            <path d={svgPaths.p232223c0} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13577" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[37.5%]" data-name="Vector">
        <div className="absolute inset-[-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.54309 4.54309">
            <path d={svgPaths.p2859ab00} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13577" />
          </svg>
        </div>
      </div>
    </div>
...
function Button14() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[280.28px] size-[13.629px] top-[8.78px]" data-name="Button">
      <Icon12 />
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute h-[31.197px] left-0 top-[18.18px] w-[303px]" data-name="Container">
      <PasswordInput />
      <Button14 />
    </div>
  );
...
function Label5() {
  return (
    <div className="absolute content-stretch flex h-[14.232px] items-start left-0 top-[2.3px] w-[92.148px]" data-name="Label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] relative shrink-0 text-[#364153] text-[10.605px]">Xác nhận mật khẩu</p>
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="h-[13.629px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[20.84%_8.33%_20.83%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.4941 9.08548">
            <path d={svgPaths.p232223c0} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13577" />
          </svg>
...
function Button16() {
  return (
    <div className="h-[27.251px] relative rounded-[7.575px] shrink-0 w-[59.251px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] left-[29.87px] text-[#364153] text-[10.605px] text-center top-[4.54px]">Hủy bỏ</p>
      </div>
    </div>
  );
}
...
function Button17() {
  return (
    <div className="bg-[#009689] h-[27.251px] relative rounded-[7.575px] shadow-[0px_0.758px_2.273px_0px_rgba(0,0,0,0.1),0px_0.758px_1.515px_0px_rgba(0,0,0,0.1)] shrink-0 w-[63.52px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[15.15px] left-[32.12px] text-[10.605px] text-center text-white top-[4.54px]">Tạo mới</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="bg-[#f9fafb] h-[64.065px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-solid border-t-[0.459px] inset-0 pointer-events-none" />
      <div className="flex flex-row justify-end size-full">
        <div className="content-stretch flex gap-[9.089px] items-start justify-end pr-[18.177px] pt-[18.636px] relative size-full">
          <Button16 />
          <Button17 />
        </div>
      </div>
...
function Container16() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[524px] items-start left-[344px] overflow-clip rounded-[10.605px] shadow-[0px_15.15px_18.938px_-3.788px_rgba(0,0,0,0.1),0px_6.06px_7.575px_-4.545px_rgba(0,0,0,0.1)] top-[33px] w-[339px]" data-name="Container">
      <Container17 />
      <Container18 />
      <Container27 />
    </div>
...
function Icon16() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1266)" id="Icon">
...
function Icon17() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1297)" id="Icon">
...
function Icon18() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1262)" id="Icon">
...
function Icon20() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1287)" id="Icon">
...
function Icon21() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1306)" id="Icon">
...
function Icon22() {
  return (
    <div className="absolute left-0 size-[20px] top-0" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_23_1277)" id="Icon">
...
export default function WorkerCreate() {
  return (
    <div className="bg-white relative size-full" data-name="Worker - Create">
      <App />
      <CreateWorkerModal />
      <Container28 />
    </div>
